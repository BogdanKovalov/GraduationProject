...
def plot_jpas_spec(row, jpas_filters=None, slice=np.s_[0:-4], issave=False):
    if jpas_filters is None:
        jpas_filters = load_jpas_filters(slice=slice)
    # JPAS fluxes
...
if __name__ == '__main__':
    ...
    for i, (idx, row) in enumerate(df_jpas_spec[10:11].iterrows()):
        print(i,idx)
        # if i < 10:
        #     continue
        # JPAS fluxes
